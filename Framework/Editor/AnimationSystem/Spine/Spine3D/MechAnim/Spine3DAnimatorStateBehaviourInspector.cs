...
namespace Framework
{
	namespace AnimationSystem
	{
		namespace Spine
		{
			namespace Editor
			{
				[CustomEditor(typeof(Spine3DAnimatorStateBehaviour))]
				public class Spine3DAnimatorStateBehaviourInspector : UnityEditor.Editor
				{
					private static class EditorHelper
					{
						private static Spine3DAnimator _animator;
						...
						public static Spine3DAnimator GetLastInspectedSpineAnimator()
						{
							return _animator;
						}
					}
